package coop.home.backaccount.controller.exceptionhandler;
...
import coop.home.backaccount.excepcion.TecnicalException;
...
class ExceptionHandlerAdvice {
	...
	@ExceptionHandler(TecnicalException.class)
	@ResponseStatus(HttpStatus.BAD_GATEWAY)
	public ErrorTemplateDTO handleTecnical(TecnicalException runtime) {
		log.error("TecnicalException code:{} Message: {}",runtime.getCodigo(),runtime.getMensaje());
