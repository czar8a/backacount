...
public class Transactions implements Serializable {
    ...
    @JoinColumns({
        ...
        , @JoinColumn(name = "IDACOUNT", referencedColumnName = "IDACOUNT", insertable = false, updatable = false)})
    ...
    public Transactions(BigInteger accountidfinancialcompany, String idacount, BigInteger idtipotransaccion, String transactiondate) {
        this.transactionsPK = new TransactionsPK(accountidfinancialcompany, idacount, idtipotransaccion, transactiondate);
    }
