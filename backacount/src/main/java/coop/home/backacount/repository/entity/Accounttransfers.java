...
public class Accounttransfers implements Serializable {
    ...
    @JoinColumns({
        ...
        , @JoinColumn(name = "SOURCEACCOUNTIDACOUNT", referencedColumnName = "IDACOUNT", insertable = false, updatable = false)})
    ...
    @JoinColumns({
        ...
        , @JoinColumn(name = "RECIPIENTACCOUNTIDACOUNT", referencedColumnName = "IDACOUNT", insertable = false, updatable = false)})
    @ManyToOne(optional = false)
    ...
    public Accounttransfers(String transferdate, BigInteger recipientaccountidcompany, String recipientaccountidacount, BigInteger sourceaccountidcompany, String sourceaccountidacount) {
        this.accounttransfersPK = new AccounttransfersPK(transferdate, recipientaccountidcompany, recipientaccountidacount, sourceaccountidcompany, sourceaccountidacount);
    }
